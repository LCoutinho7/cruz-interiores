    ...
    <section className="py-20 md:py-28 px-6 md:px-8 max-w-[1200px] mx-auto">
      <div className="text-center max-w-3xl mx-auto mb-16 gsap-reveal">
        ...
        <p className="font-body-lg text-base md:text-lg text-[#44464e]">
          A Cruz Interiores atua de duas formas — escolha a modalidade ideal para o seu projeto e localidade.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch gsap-stagger">
        {/* Card 1: Projeto Completo em Curitiba */}
        <div className="bg-white border-2 border-[#1f57c9]/30 rounded-xl p-8 md:p-10 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between relative group">
          <div className="absolute top-4 right-4 bg-[#d9e2ff] text-[#051a40] text-[11px] font-bold uppercase tracking-wider px-3 py-1 rounded-full">
            Curitiba & Região
          </div>

          <div>
            <div className="w-14 h-14 rounded-lg bg-[#0b1f45] text-white flex items-center justify-center mb-6 shadow-sm">
              <Hammer size={28} />
            </div>
            ...
            <p className="font-body-md text-[#44464e] text-sm md:text-base leading-relaxed mb-6">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-2.5 text-sm text-[#191c1d]">
          ...
          <div className="pt-4 border-t border-[#E9ECEF] flex flex-col sm:flex-row gap-3">
            <button
              onClick={() => handleWhatsAppSelect('instalacao')}
              className="w-full py-3.5 bg-[#1f57c9] hover:bg-[#1E56C8] text-white font-button text-xs font-semibold rounded transition-colors flex items-center justify-center gap-2 group-hover:bg-[#1E56C8]"
            >
        ...
        <div className="bg-[#f8f9fa] border border-[#c5c6cf] rounded-xl p-8 md:p-10 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between relative group">
          <div className="absolute top-4 right-4 bg-[#e1e3e4] text-[#44464e] text-[11px] font-bold uppercase tracking-wider px-3 py-1 rounded-full">
            Todo o Brasil
          </div>

          <div>
            <div className="w-14 h-14 rounded-lg bg-[#1f57c9] text-white flex items-center justify-center mb-6 shadow-sm">
              <Truck size={28} />
            </div>
          ...
          <div className="pt-4 border-t border-[#E9ECEF]">
            <button
              ...
              className="w-full py-3.5 border-2 border-[#1f57c9] text-[#1f57c9] hover:bg-[#1f57c9] hover:text-white font-button text-xs font-semibold rounded transition-colors flex items-center justify-center gap-2"
            >
