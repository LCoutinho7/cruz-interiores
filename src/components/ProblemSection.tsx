  ...
  return (
    <section className="py-16 md:py-24 bg-[var(--color-primary)] text-white relative overflow-hidden">
      <div className="max-w-[1000px] mx-auto px-6 md:px-8 text-center relative z-10 gsap-scale-up">
        <div className="w-12 h-12 rounded-full bg-white/10 text-[var(--color-secondary)] flex items-center justify-center mx-auto mb-6 border border-white/20">
        ...
        <p className="font-body-lg text-base md:text-lg text-[var(--color-secondary-container)] leading-relaxed max-w-3xl mx-auto font-light">
